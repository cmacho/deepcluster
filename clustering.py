...
def run_kmeans(x, nmb_clusters, verbose=False):
    ...
    """
    n_data, d = x.shape
    print("run Kmeans.fit")
    kmeans = KMeans(n_clusters=nmb_clusters, init="k-means++", n_init=1, max_iter=300).fit(x)
    # alternative:
    # labels, loss = kmeans.kmeans(x, nmb_clusters, max_iter=300)
    print("finished Kmeans.fit")
